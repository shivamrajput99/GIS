...
<ul class="nav menu">
  ...
  <center>
                    ...
                    <div class="row">
			<div class="col-lg-12">
                        <legend><h1>Browse Photo</h1></legend>
                        </div>
                </div></center>
                <center>
                    <div class="center">
        <table border="1"> 
          <%
            ...
            String st=request.getParameter("placeid");
             ...
             String st5=request.getParameter("file");
...
<input type="hidden" value="<%=st2%>" name=="pname"/>
        ...
        <form name="vivek" action="addphotoprocess.jsp" method="post" enctype="multipart/form-data" >
            ...
            <tr border="1" class="table"><td>List of Photo:</td><td></td></tr>
            
            <% 
            String query1 = "Select * from file1  where  t_place_id='"+st+"'";
...
while(rs.next())
   ...
   // out.println("hii");
            ...
            <tr border="1" class="table"><td><a href="deletephoto.jsp?fileid=<%out.println(rs.getString("file_id"));%>"> <img src="images/del.jpg" alt="ed" width="50px" height="30px"></a> </td><td>  <img src="..//upload//<%out.println(rs.getString("file_path"));%>"  width="100px" height="100px"/>   </td></tr>
            <%}%>
            <tr border="1" class="table"><td>Add photo</td>
    <td>  <img src="images/no_image-512.png" alt="ed" width="100px" height="100px"/>   </td>
         </tr>
<br> <tr><td></td><td> <input type="file"  name="file" id="file" required/></td></tr>
