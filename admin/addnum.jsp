...
<center>
                    ...
                    <div class="row">
			<div class="col-lg-12">
                        <legend><h1>Place Number</h1></legend>
                        </div>
                </div></center>
                
        <table border="1" class="table">
                <tbody>
                    <tr><td>SNo</td><td>Number</td><td>Name</td><td>City id</td><td>State id</td><td>Category</td></tr>     
...
<tr><td><% out.println(rs1.getInt("t_place_id"));%></td>
              ...
              <td>
  <a href="addnumber.jsp?placeid=<% out.println(rs1.getString("t_place_id"));%>&&pname=<% out.println(rs1.getString("t_place_name"));%>&&city=<% out.println(rs1.getString("cname"));%>&&state=<% out.println(rs1.getString("name"));%>&&file=<% //out.println(rs1.getString("file_path"));%>"><input type="button" value="Number"></a>
        </td>
