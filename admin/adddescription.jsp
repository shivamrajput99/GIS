...
<ul class="nav menu">
  ...
  <center>
                    ...
                    <div class="row">
			<div class="col-lg-12">
                        <legend><h1>Add Description</h1></legend>
                        </div>
                </div></center>
                <center>
...
<input type="hidden" value="<%=st2%>" name=="pname"/>
        ...
        <form name="vivek" action="adddescprocess.jsp" method="post">
            ...
            <tr border="1" class="table"><td>Description:</td><td></td></tr>
            
            <% 
            String query1 = "Select * from  placedescription  where  t_place_id='"+st+"'";
...
while(rs.next())
   ...
   // out.println("hii");
            ...
            <tr border="1" class="table"><td><a href="deletedes.jsp?desid=<%out.println(rs.getString("t_place_description_id"));%>"> <img src="images/del.jpg" alt="ed" width="50px" height="30px"></a> </td><td>  <%out.println(rs.getString("t_place_description"));%>   </td></tr>
            <%}%>
     
<br> <tr><td>Add Description</td><td> <input type="text"  name="pd" id="pd" required/></td></tr>
