...
<ul class="nav menu">
  ...
  <center>
                    ...
                    <div class="row">
			<div class="col-lg-12">
                        <legend><h1>Add Address</h1></legend>
                        </div>
                </div></center>
                <center>
                    <div class="center">
...
<input type="hidden" value="<%=st2%>" name=="pname"/>
        ...
        <form name="vivek" action="addressprocess.jsp" method="post">
            ...
            <tr border="1" class="table"><td>Place Address</td><td></td></tr>
            
            <% 
            String query1 = "Select * from   placeaddress  where  t_place_id='"+st+"'";
...
while(rs.next())
   ...
   // out.println("hii");
            ...
            <tr border="1" class="table"><td><a href="deleteaddress.jsp?addid=<%out.println(rs.getString("t_address_id"));%>"> <img src="images/del.jpg" alt="ed" width="50px" height="30px"></a> </td><td>  <%out.println(rs.getString("t_address_name"));%>   </td></tr>
            <%}%>
     
<br> <tr><td>Add Address</td><td> <input type="text"  name="pd" id="pd" required/></td></tr>
