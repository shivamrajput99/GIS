	...
	<div class="container">
	 &nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div class="short-codes wow bounceInLeft" data-wow-delay="0.3s">
		 ...
		 <h3 class="typo1">Sterling Hospitals</h3>
   ...
   <div class="hotel-bottom">
				...
				<div class="experts wow bounceInRight" data-wow-delay="0.3s">
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
 								<img src="images/sterling1.jpg" alt=" " height="250px" width="350px"/>
									<div class="captn">
										<h4>Sterling Hospitals</h4>
 									</div>
 							</div>
						</div>
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
				<img src="images/sterling2.jpg" alt=" " height="250px" width="350px" />
									<div class="captn">
										<h4>Sterling Hospitals</h4>
 									</div>
							</div>
						...
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
								<img src="images/sterling4.jpg" alt=" " height="250px" width="350px" />
									<div class="captn">
										<h4>Sterling Hospitals</h4>
 									</div>
							</div>
...
<h3><b>Address:</b>Near Maharaja Agrasen Vidhyalaya, Near Gurukul,, Sterling Hospital Rd, Nilmani Society, Memnagar, Ahmedabad, Gujarat 380052</h3>
...
<h3><B>Details:</B>Sterling Hospitals is one of the largest hospital chains in Gujarat, considered to be the leading one by the levels of independent certification, facilities and equipment, as well as size and capacities. It is owned and managed by Sterling AddLife India Ltd.
