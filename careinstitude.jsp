	...
	<div class="container">
	 &nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <div class="short-codes wow bounceInLeft" data-wow-delay="0.3s">
		 ...
		 <h3 class="typo1">Care Institute of Medical Sciences (CIMS)</h3>
   ...
   <div class="hotel-bottom">
				...
				<div class="experts wow bounceInRight" data-wow-delay="0.3s">
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
 								<img src="images/care1.jpg" alt=" " height="250px" width="350px"/>
									<div class="captn">
										<h4>CIMS</h4>
 									</div>
 							</div>
						...
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
				<img src="images/care2.jpg" alt=" " height="250px" width="350px" />
									<div class="captn">
										<h4>CIMS</h4>
 									</div>
							</div>
						...
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
								<img src="images/care3.jpg" alt=" " height="250px" width="350px" />
									<div class="captn">
										<h4>CIMS</h4>
 									</div>
							</div>
						...
						<div class="col-md-3 bottom-grid">
							<div class="btm-right">
								<img src="images/care4.jpg" alt=" " height="250px" width="350px" />
									<div class="captn">
										<h4>CIMS</h4>
 									</div>
							</div>
...
<h3><b>Address:</b>Opposite Panchamrut Bunglows, Near Shukan Mall, Off Science City Road, Sola, Ahmedabad, Gujarat 380060</h3>
