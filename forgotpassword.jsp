...
&nbsp;&nbsp;&nbsp;&nbsp;
       <div class="short-codes wow bounceInLeft" data-wow-delay="0.3s">
		 ...
		 <h3 class="typo1">Show Password</h3>
		 
                                   <div class="clearfix"> </div>

			<hr class="colorgraph">
                <form id="forgotpasswordprocess" action="forgotpasswordprocess.jsp" method="post" >
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
                         <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block btn-lg" formaction="forgotpasswordprocess.jsp">Show Password</button>
                </div>
        </div> 
                         
				<div class="col-xs-12 col-sm-6 col-md-6">
                         <div class="form-group">
                             <a href="login.jsp" class="btn btn-success btn-block btn-lg">Sign to your account</a>
                </div>
        </div></div>
...
<% if(request.getParameter("pass")!=null){ %>   
    ...
    <script type="text/javascript">
       ...
       alert("Your Account Password is : "+pass);     
    </script> 
    
<% } %>

<% if(request.getParameter("notpass")!=null){ %>   

    <script type="text/javascript">
       var pass = "<%=request.getParameter("notpass")%>";
       alert("We does not have Account in this Website");     
    </script> 
